...
function useForceUpdate() {
  ...
  const [forcedRenderCount, setForcedRenderCount] = (0, import_react18.useState)(0);
  const forceRender = (0, import_react18.useCallback)(() => {
    isMounted.current && setForcedRenderCount(forcedRenderCount + 1);
  }, [forcedRenderCount]);
  const deferredForceRender = (0, import_react18.useCallback)(() => frame.postRender(forceRender), [forceRender]);
...
function PopChild({ children, isPresent }) {
  ...
  const size = (0, import_react19.useRef)({
    width: 0,
    height: 0,
    top: 0,
    left: 0
...
function useUnmountEffect(callback) {
  return (0, import_react21.useEffect)(() => () => callback(), []);
}
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, exitBeforeEnter, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  const forceRender = (0, import_react22.useContext)(LayoutGroupContext).forceRender || useForceUpdate()[0];
  const isMounted = useIsMounted();
  const filteredChildren = onlyElements(children);
  let childrenToRender = filteredChildren;
  const exitingChildren = (0, import_react22.useRef)(/* @__PURE__ */ new Map()).current;
  const presentChildren = (0, import_react22.useRef)(childrenToRender);
  const allChildren = (0, import_react22.useRef)(/* @__PURE__ */ new Map()).current;
  ...
  return React4.createElement(React4.Fragment, null, exitingChildren.size ? childrenToRender : childrenToRender.map((child) => (0, import_react22.cloneElement)(child)));
};
...
function MotionConfig({ children, isValidProp, ...config }) {
  ...
  config = { ...(0, import_react23.useContext)(MotionConfigContext), ...config };
  config.isStatic = useConstant(() => config.isStatic);
  const context = (0, import_react23.useMemo)(() => config, [JSON.stringify(config.transition), config.transformPagePoint, config.reducedMotion]);
...
function LazyMotion({ children, features, strict = false }) {
  const [, setIsLoaded] = (0, import_react24.useState)(!isLazyBundle(features));
  const loadedRenderer = (0, import_react24.useRef)(void 0);
...
function CalendarCell(originalProps) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("td", { className: slots == null ? void 0 : slots.cell({ class: classNames == null ? void 0 : classNames.cell }), "data-slot": "cell", ...cellProps, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    "button",
    {
      ...(0, import_utils12.mergeProps)(buttonProps, hoverProps, focusProps),
      ref,
...
function CalendarMonth(props) {
  ...
  const [state, setState] = (0, import_react26.useState)(() => stateProp);
...
var CalendarPickerItem = (0, import_react28.forwardRef)(({ children, autoFocus, isDisabled, onKeyDown, ...otherProps }, ref) => {
...
function useCalendarPicker(props) {
  ...
  const highlightRef = (0, import_react29.useRef)(null);
  const yearsListRef = (0, import_react29.useRef)(null);
  const monthsListRef = (0, import_react29.useRef)(null);
  const monthsItemsRef = (0, import_react29.useRef)();
  const yearsItemsRef = (0, import_react29.useRef)();
  ...
  const handleListScroll = (0, import_react29.useCallback)(
    (e, highlightEl, list) => {
  ...
  const onPickerItemPressed = (0, import_react29.useCallback)(
    (e, list) => {
  ...
  const onPickerItemKeyDown = (0, import_react29.useCallback)(
    (e, value, list) => {
      var _a2;
      const map = getItemsRefMap(list === "months" ? monthsItemsRef : yearsItemsRef);
      const node = map.get(value);
...
function CalendarPicker(props) {
  ...
  const EmptyItem = (0, import_react30.useCallback)(
  ...
  const PickerItemWrapper = (0, import_react30.useCallback)(
...
function CalendarBase(props) {
  ...
  const [direction, setDirection] = (0, import_react32.useState)(0);
  const { direction: rtlDirection } = (0, import_i18n5.useLocale)();
  ...
  for (let i = 0; i < visibleMonths; i++) {
    ...
    headers.push(
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(import_react31.Fragment, { children: [
        i === 0 && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          import_button2.Button,
          {
            ...prevButtonProps,
            onPress: (0, import_utils15.chain)(prevButtonProps.onPress, () => setDirection(-1)),
        ...
        i === visibleMonths - 1 && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          ...
          {
            ...nextButtonProps,
            onPress: (0, import_utils15.chain)(nextButtonProps.onPress, () => setDirection(1)),
    ...
    const calendarMonthContent = /* @__PURE__ */ (0, import_react33.createElement)(
      CalendarMonth,
      {
        ...props,
    ...
    calendars.push(
      showMonthAndYearPickers ? /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(import_react31.Fragment, { children: [
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(Component2, { ...(0, import_utils15.mergeProps)(calendarProps, otherProps), ref, children: [
    topContent,
