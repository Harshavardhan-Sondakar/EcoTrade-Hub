...
function useDateRangePicker({
  ...
  let {
    ...
    descriptionProps,
    errorMessageProps
  } = (0, import_datepicker2.useDateRangePicker)(originalProps, state, domRef);
  ...
  const getStartDateInputProps = (props = {}) => {
    return {
      ...
      createCalendar,
      ...(0, import_utils2.mergeProps)(variantProps, startFieldProps, {
        fullWidth: true,
        disableAnimation
      }),
  ...
  const getEndDateInputProps = (props = {}) => {
    return {
      ...
      slots: dateInputSlots,
      createCalendar,
      ...(0, import_utils2.mergeProps)(variantProps, endFieldProps, {
        fullWidth: true,
        disableAnimation
      }),
      "data-open": (0, import_shared_utils2.dataAttr)(state.isOpen),
