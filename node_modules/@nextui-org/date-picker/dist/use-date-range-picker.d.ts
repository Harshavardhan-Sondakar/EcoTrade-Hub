...
declare function useDateRangePicker<T extends DateValue>({ as, label, isInvalid, description, startContent, endContent, selectorIcon, errorMessage, className, classNames, ...originalProps }: UseDateRangePickerProps<T>): {
    ...
    slots: {
        base: (slotProps?: ({
            ...
            hasMultipleMonths?: boolean | undefined;
    ...
    isCalendarHeaderExpanded: boolean;
