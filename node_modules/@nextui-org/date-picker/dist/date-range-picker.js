...
__export(date_range_picker_exports, {
  default: () => date_range_picker_default
});
...
function DateRangePickerField(props, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Component2, { ...(0, import_utils.mergeProps)(fieldProps, (0, import_react_utils.filterDOMProps)(otherProps)), ref: domRef, children: [
...
var date_range_picker_field_default = (0, import_react12.forwardRef)(DateRangePickerField);
...
function useDatePickerBase(originalProps) {
  ...
  const [isCalendarHeaderExpanded, setIsCalendarHeaderExpanded] = (0, import_react13.useState)(false);
  const {
    as,
    ref,
    label,
  ...
  const slotsProps = {
    ...
    selectorButtonProps: (0, import_utils2.mergeProps)(
      {
        isIconOnly: true,
        radius: "full",
        size: "sm",
    ...
    calendarProps: (0, import_utils2.mergeProps)(
      {
        showHelper: false,
        visibleMonths,
        pageBehavior,
  ...
  const popoverProps = {
    ...(0, import_utils2.mergeProps)(slotsProps.popoverProps, props),
    triggerRef: domRef
  };
  const calendarProps = {
    ...
    style: (0, import_utils2.mergeProps)(
      hasMultipleMonths ? {
...
function useDateRangePicker({
  ...
  let state = (0, import_datepicker3.useDateRangePickerState)({
    ...originalProps,
    shouldCloseOnSelect: () => !state.hasTime
  });
  const popoverTriggerRef = (0, import_react14.useRef)(null);
  ...
  let {
    ...
    descriptionProps,
    errorMessageProps
  } = (0, import_datepicker4.useDateRangePicker)(originalProps, state, domRef);
  ...
  const labelPlacement = (0, import_react14.useMemo)(() => {
    var _a;
    ...
    return {
      ...
      classNames: {
        base: slots.timeInput({
          class: (0, import_shared_utils2.clsx)(classNames == null ? void 0 : classNames.timeInput, (_b = userTimeInputProps == null ? void 0 : userTimeInputProps.classNames) == null ? void 0 : _b.base)
        }),
  ...
  const dateInputSlots = (0, import_react14.useMemo)(
...
function DateRangePicker(props, ref) {
  ...
  const selectorContent = (0, import_react16.isValidElement)(selectorIcon) ? (0, import_react16.cloneElement)(selectorIcon, getSelectorIconProps()) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_shared_icons.CalendarBoldIcon, { ...getSelectorIconProps() });
  const calendarBottomContent = (0, import_react15.useMemo)(() => {
    if (isCalendarHeaderExpanded)
      return null;
    return showTimeField ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: slots == null ? void 0 : slots.bottomContent({ class: classNames == null ? void 0 : classNames.bottomContent }), children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: slots == null ? void 0 : slots.timeInputWrapper({ class: classNames == null ? void 0 : classNames.timeInputWrapper }), children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_date_input2.TimeInput, { ...getStartTimeInputProps() }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_date_input2.TimeInput, { ...getEndTimeInputProps() })
      ] }),
      CalendarBottomContent
    ] }) : CalendarBottomContent;
  }, [state, showTimeField, CalendarBottomContent, isCalendarHeaderExpanded]);
  const calendarTopContent = (0, import_react15.useMemo)(() => {
    if (isCalendarHeaderExpanded)
      return null;
    return CalendarTopContent;
  }, [showTimeField, CalendarTopContent, isCalendarHeaderExpanded]);
  const popoverContent = state.isOpen ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_popover.FreeSoloPopover, { ...getPopoverProps(), offset: 20, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    import_calendar.RangeCalendar,
    {
      ...getCalendarProps(),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
      import_date_input2.DateInputGroup,
      {
        ...getDateInputGroupProps(),
        endContent: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_button.Button, { ...getSelectorButtonProps(), children: endContent || selectorContent }),
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(date_range_picker_field_default, { ...getStartDateInputProps() }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { ...getSeparatorProps(), "aria-hidden": "true", role: "separator", children: "-" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(date_range_picker_field_default, { ...getEndDateInputProps() })
        ]
      }
    ),
    disableAnimation ? popoverContent : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(AnimatePresence, { children: popoverContent })
  ] });
}
DateRangePicker.displayName = "NextUI.DateRangePicker";
var date_range_picker_default = (0, import_system2.forwardRef)(DateRangePicker);
