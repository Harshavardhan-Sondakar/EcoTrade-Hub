...
function useCheckbox(props = {}) {
  ...
  const {
    ...
    (0, import_toggle.useToggleState)(ariaCheckboxProps),
    inputRef
  );
  ...
  const [isChecked, setIsChecked] = (0, import_react.useState)(!!defaultSelected || !!isSelected);
  ...
  const getBaseProps = (0, import_react.useCallback)(() => {
    return {
      ...
      "data-selected": (0, import_shared_utils.dataAttr)(isSelected || isIndeterminate || isChecked),
  ...
  const getInputProps = (0, import_react.useCallback)(() => {
    return {
      ...
      ...(0, import_utils.mergeProps)(inputProps, focusProps, { checked: isChecked }),
      onChange: (0, import_utils.chain)(inputProps.onChange, onChange, handleCheckboxChange)
    };
  ...
  const getIconProps = (0, import_react.useCallback)(
    ...
    [slots, classNames == null ? void 0 : classNames.icon, isSelected, isIndeterminate, disableAnimation, isChecked]
  );
  return {
    Component,
    icon,
